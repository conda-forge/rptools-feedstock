...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rptools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14371&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rptools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rptools` can be installed with:

```
conda install rptools
```

It is possible to list all of the versions of `rptools` available on your platform with:
